            ...
            <div className="cards-container">
                ...
                <a href="https://github.com/ChaitraliWaikar/MoneyWise" target="_blank" rel="noopener noreferrer">
                    <div className="card">
                        ...
                        <p className="desc">
                            AI-powered multi-agent web app that helps users improve financial literacy and manage budgets.
                            Built with <span className="highlight">Flask and Google Generative AI API.</span>
                        </p>
                        <button className="view-btn">View Project details</button>
                    </div>
                </a>
                ...
                <a href="https://github.com/ChaitraliWaikar/Python_AI_Projects" target="_blank" rel="noopener noreferrer">
                    <div className="card">
                        <img src="/images/Tweetgen.png" className="img-container" alt="proj-img" />
                        <h3 className="proj-title">AIML Projects</h3>
                        <p className="desc">
                            AI and Machine Learning Projects repository containing various AI and ML projects, including image recognition,
